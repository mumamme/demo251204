...
https://docs.parasoft.com/display/JTESTJP20252/Integrating+with+Build+Systems
...
1. Jtest ユーザー ガイドに従って Maven を設定します。
   https://docs.parasoft.com/display/JTESTJP20252/Configuring+the+Jtest+Plugin+for+Maven
...
詳細は以下を参照してください。
   https://docs.parasoft.com/display/JTESTJP20252/Testing+and+Analysis+with+Maven
   https://docs.parasoft.com/display/JTESTJP20252/Testing+and+Analysis+with+Gradle
...
詳細は https://docs.parasoft.com/display/JTESTJP20252/Application+Coverage を参照してください。
